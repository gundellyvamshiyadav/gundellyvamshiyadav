<!-- Professional Banner (Upload your own banner image to your repo and set the correct path below) -->
<!-- Example: Place your banner at /assets/banner.png, then use the following: -->
<!-- <p align="center"> -->
<!--   <img src="assets/banner.png" width="100%" alt="Professional Banner"/> -->
<!-- </p> -->
<!-- If you don't want a banner yet, you can remove this section or add one later. -->
...
<p>
  The chart above shows the languages you use most in your public and private repositories, based on file size and repo visibility. If you see "no language data," try pushing more code or updating your main projects.
</p>
</details>
